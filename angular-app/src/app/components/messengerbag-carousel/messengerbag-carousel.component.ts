...
@Component({
  ...
  templateUrl: './messengerbag-carousel.component.html',
  styleUrls: ['./messengerbag-carousel.component.css']
})
export class MessengerbagCarouselComponent implements OnInit {
  allProducts: any;
  constructor(
