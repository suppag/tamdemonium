...
@Component({
  ...
  templateUrl: './messengerbags-category.component.html',
  styleUrls: ['./messengerbags-category.component.css']
})
export class MessengerbagsCategoryComponent implements OnInit {
  allProducts: any;
  constructor(
